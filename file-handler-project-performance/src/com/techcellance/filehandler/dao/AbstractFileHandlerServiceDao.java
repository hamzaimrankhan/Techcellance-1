...
//	}
	...
	protected  final static String QRY_FETCH_AGENT_CODE_INFORMAITON = "select mfi.acquirer_account,mfi.legal_entity_address,mfi.legal_entity_city,mfi.legal_post_code,mfi.country_code From  mid_file_information mfi , bin_file_information bfi where bfi.brand = mfi.payment_method  and mfi.currency_code like ? and mfi.aa_country_code = ? and mfi.iata_carrier_code =? and bfi.range_from <= ? <= bfi.range_until";
